...
import com.yuhui.blog.dao.*;
import com.yuhui.blog.dto.*;
import com.yuhui.blog.entity.Article;
import com.yuhui.blog.entity.WebsiteConfig;
...
public class BlogInfoServiceImpl implements BlogInfoService {
    ...
    public BlogHomeInfoDTO getBlogHomeInfo() {
        ...
        // Optional.ofNullable(count).orElse() 底层就是一个包装好的三元运算，避免空指针。
        // 注意字符串就别用它判空了，""空字符判定为非空，老老实实用StringUtils.isEmpty
