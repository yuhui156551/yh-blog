...
import com.yuhui.blog.dao.PhotoAlbumDao;
import com.yuhui.blog.dao.PhotoDao;
import com.yuhui.blog.dto.PhotoAlbumBackDTO;
import com.yuhui.blog.dto.PhotoAlbumDTO;
import com.yuhui.blog.entity.Photo;
import com.yuhui.blog.entity.PhotoAlbum;
import com.yuhui.blog.exception.BizException;
import com.yuhui.blog.service.PhotoAlbumService;
...
import com.yuhui.blog.vo.PhotoAlbumVO;
...
import static com.yuhui.blog.enums.PhotoAlbumStatusEnum.PUBLIC;
...
public class PhotoAlbumServiceImpl extends ServiceImpl<PhotoAlbumDao, PhotoAlbum> implements PhotoAlbumService {
    ...
    public PhotoAlbumBackDTO getPhotoAlbumBackById(Integer albumId) {
        ...
        photoAlbumBackDTO.setPhotoCount(photoCount);
    ...
    public void deletePhotoAlbumById(Integer albumId) {
        ...
        if (count > 0) {
            ...
            photoAlbumDao.updateById(PhotoAlbum.builder()
                    ...
                    .isDelete(TRUE)
                    .build());
            /*LambdaQueryWrapper<Photo> queryWrapper = new LambdaQueryWrapper<Photo>().eq(Photo::getAlbumId, albumId);
            Photo photo = new Photo();
            photo.setIsDelete(TRUE);
            photoDao.update(photo, queryWrapper);*/
