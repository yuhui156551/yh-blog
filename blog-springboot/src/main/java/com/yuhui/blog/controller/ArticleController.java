...
import com.yuhui.blog.service.ArticleService;
import com.yuhui.blog.strategy.context.ArticleImportStrategyContext;
...
import static com.yuhui.blog.constant.OptTypeConst.*;
...
public class ArticleController {
    ...
    public Result<String> saveArticleImages(MultipartFile file) {
        return Result.ok(uploadStrategyContext.executeUploadStrategy(file, FilePathEnum.ARTICLE.getPath()));// "articles/"
    }
     ...
     */
    @ApiOperation(value = "根据id回显后台文章数据")
