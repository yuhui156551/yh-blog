...
import com.yuhui.blog.strategy.UploadStrategy;
...
import static com.yuhui.blog.enums.UploadModeEnum.getStrategy;
...
public class UploadStrategyContext {
    ...
    public String executeUploadStrategy(MultipartFile file, String path) {
        return uploadStrategyMap.get(getStrategy(uploadMode)).uploadFile(file, path);// localUploadStrategyImpl
    }
